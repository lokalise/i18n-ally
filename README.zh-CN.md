...
<p align='center'>
<b>v2.0</b> 已更新，伴随新的 <a href='https://github.com/antfu/i18n-ally/wiki/Migration-v1.x'>可视化编辑器</a> 和 <a href='https://github.com/antfu/i18n-ally/wiki/Review-System'>审阅系统</a> 🎉
</p>

<p align='center'><i>
<a href="https://github.com/antfu/i18n-ally/wiki/Migration-v1.x">从 v1.x 迁移到 v2.0</a>
</i></p>
<br>

<p align='center'><b>
🚧 请注意，中文文档仅供参考，非实时更新。可能会与英文版有所出入，如有歧义，一切请以<a href="https://github.com/antfu/i18n-ally/blob/master/README.md">英文文档</a>为主。
</b></p>
...
<details>
<summary align='center'><b>🧱 支持框架</b></summary>

插件会根据当前项目的依赖自动检测框架。

<table>
<thead><tr><th>框架</th><th>触发依赖</th></tr></thead>
<tbody>
...
<sub>通过<code>&quot;i18n-ally.enabledFrameworks&quot;: &quot;chrome-ext&quot;</code>手动设置</sub>
</td></tr>

<tr><td>
🎎 <strong>自定义</strong>
</td><td>
<strong><a href="https://github.com/antfu/i18n-ally/wiki/Custom-Framework">几乎支持所有框架...</a></strong></td>
</tr>
...
如果你想要使用以上未列出的框架，你可以：
  ...
  - 发起一个[框架支持请求](https://github.com/antfu/i18n-ally/issues/new?assignees=&labels=framework+request&template=framework-support-request.md&title=%5BFramework+Request%5D)
  - Fork 并发起 PR
  - [设置你的自定义框架]](https://github.com/antfu/i18n-ally/wiki/Custom-Framework)
...
<h3 align='center'><a href='https://github.com/antfu/i18n-ally/wiki/Editor-UI'>可视化编辑器</a> 和 <a href='https://github.com/antfu/i18n-ally/wiki/Review-&-Collaboration-System'>审阅系统</a></h3>
...
- 支持大多数流行框架
- 插件自身多语言支持 [翻译列表](https://github.com/antfu/i18n-ally#-multilingual-support)
...
[查看维基](https://github.com/antfu/i18n-ally/wiki)!


## 💭 常见问题

[常见问题](https://github.com/antfu/i18n-ally/wiki/FAQ).
...
[支持的文件格式](https://github.com/antfu/i18n-ally/wiki/Supported-Locale-Formats).
...
我在这个项目里投入了许多精力和时间，如果您觉得它有对你有所帮助，你可以考虑请我喝杯咖啡以支持我的工作！感谢！

- [PayPal](https://paypal.me/antfu7)
- [支付宝](https://github.com/antfu/vue-i18n-ally/blob/master/screenshots/alipay.jpg)

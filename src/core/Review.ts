...
export class Reviews {
  ...
  async discardTranslationCandidate(key: string, locale: string) {
    await this.set(key, 'translation_candidate', undefined, locale)
  }
  ...
  private async save() {
    ...
    let content = YAML.safeDump(this.data, { skipInvalid: true })
